...
const config = require('./config.json'); // To store credentials like api codes and passwords
...
//Connect to database
// const mongodbURI = 'mongodb+srv://Chikaylah:<password>@clustershay-nxq8s.mongodb.net/test?retryWrites=true&w=majority';
...
// including bodyParser, cors and bcryptjs
...
app.delete('/deleteProduct/:id',(req,res)=>{
  const idParam = req.params.id;
  Product.findOne({_id:idParam}, (err,product)=>{ // _id refers to mogodb
    if (product){
